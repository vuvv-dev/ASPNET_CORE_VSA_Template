using F012.Models;
using F012.Presentation;
using Microsoft.AspNetCore.Http;

namespace F012.Common;

public static class Constant
{
    public const string CONTROLLER_NAME = "F012Endpoint";

    public const string ENDPOINT_PATH = "F012/task/{TodoTaskId:required}";
