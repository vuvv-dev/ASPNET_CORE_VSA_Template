...
using F018.BusinessLogic;
using F018.Common;
using F018.Mapper;
using F018.Models;
using F018.Presentation.Filters.SetStateBag;
using F018.Presentation.Filters.Validation;
...
public sealed class Endpoint : ControllerBase
{
    ...
    public async Task<IActionResult> ExecuteF018Async(
