...
using F017.BusinessLogic;
using F017.Common;
using F017.Mapper;
using F017.Models;
using F017.Presentation.Filters.SetStateBag;
using F017.Presentation.Filters.Validation;
...
public sealed class Endpoint : ControllerBase
{
    ...
    public async Task<IActionResult> ExecuteF017Async(
