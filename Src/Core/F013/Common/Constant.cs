using F013.Models;
using F013.Presentation;
using Microsoft.AspNetCore.Http;

namespace F013.Common;

public static class Constant
{
    public const string CONTROLLER_NAME = "F013Endpoint";
    public const string ENDPOINT_PATH =
        "F013/list/{TodoTaskListId:required}/task/cursor/{TodoTaskId:required}";
