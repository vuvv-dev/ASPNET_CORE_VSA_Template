...
using F020.BusinessLogic;
using F020.Common;
using F020.Mapper;
using F020.Models;
using F020.Presentation.Filters.SetStateBag;
using F020.Presentation.Filters.Validation;
...
public sealed class Endpoint : ControllerBase
{
    ...
    public async Task<IActionResult> ExecuteF020Async(
