...
using F010.BusinessLogic;
using F010.Common;
using F010.Mapper;
using F010.Models;
using F010.Presentation.Filters.SetStateBag;
using F010.Presentation.Filters.Validation;
...
public sealed class Endpoint : ControllerBase
{
    ...
    public async Task<IActionResult> ExecuteF010Async(
