...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FA1.Entities.AdditionalUserInfoEntity", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("FA1.Entities.IdentityRoleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Entities.IdentityUserEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Entities.TodoTaskEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Entities.TodoTaskListEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Entities.TodoTaskStepEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Entities.IdentityUserTokenEntity", b =>
                {
            ...
            modelBuilder.Entity("FA1.Entities.AdditionalUserInfoEntity", b =>
                {
                    b.HasOne("FA1.Entities.IdentityUserEntity", "IdentityUser")
                        .WithOne("AdditionalUserInfo")
                        .HasForeignKey("FA1.Entities.AdditionalUserInfoEntity", "Id")
            ...
            modelBuilder.Entity("FA1.Entities.TodoTaskEntity", b =>
                {
                    b.HasOne("FA1.Entities.TodoTaskListEntity", "TodoTaskList")
                        .WithMany("TodoTasks")
            ...
            modelBuilder.Entity("FA1.Entities.TodoTaskListEntity", b =>
                {
                    b.HasOne("FA1.Entities.AdditionalUserInfoEntity", "User")
            ...
            modelBuilder.Entity("FA1.Entities.TodoTaskStepEntity", b =>
                {
                    b.HasOne("FA1.Entities.TodoTaskEntity", "TodoTask")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("FA1.Entities.IdentityRoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("FA1.Entities.IdentityUserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
