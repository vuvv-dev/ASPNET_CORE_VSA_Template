...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FA1.Src.Entities.AdditionalUserInfoEntity", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("FA1.Src.Entities.IdentityRoleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Src.Entities.IdentityUserEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Src.Entities.TodoTaskEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Src.Entities.TodoTaskListEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Src.Entities.TodoTaskStepEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FA1.Src.Entities.IdentityUserTokenEntity", b =>
                {
            ...
            modelBuilder.Entity("FA1.Src.Entities.AdditionalUserInfoEntity", b =>
                {
                    b.HasOne("FA1.Src.Entities.IdentityUserEntity", "IdentityUser")
                        .WithOne("AdditionalUserInfo")
                        .HasForeignKey("FA1.Src.Entities.AdditionalUserInfoEntity", "Id")
            ...
            modelBuilder.Entity("FA1.Src.Entities.TodoTaskEntity", b =>
                {
                    b.HasOne("FA1.Src.Entities.TodoTaskListEntity", "TodoTaskList")
                        .WithMany("TodoTasks")
            ...
            modelBuilder.Entity("FA1.Src.Entities.TodoTaskListEntity", b =>
                {
                    b.HasOne("FA1.Src.Entities.AdditionalUserInfoEntity", "User")
            ...
            modelBuilder.Entity("FA1.Src.Entities.TodoTaskStepEntity", b =>
                {
                    b.HasOne("FA1.Src.Entities.TodoTaskEntity", "TodoTask")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("FA1.Src.Entities.IdentityRoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("FA1.Src.Entities.IdentityUserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
